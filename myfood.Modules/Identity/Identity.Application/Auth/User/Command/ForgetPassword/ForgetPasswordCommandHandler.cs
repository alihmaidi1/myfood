...
//     private readonly UserManager<Domain.Security.Admin>  _userManager;
//
//
//     public ForgetPasswordCommandHandler(IUnitOfWork unitOfWork,UserManager<Domain.Security.Admin>  userManager,ISmsTwilioService  smsTwilioService)
//     {
